...
ALTER TABLE CNS_FACTURE ADD CONSTRAINT CNS_FACTURE_CNS_DOCTORS_FK FOREIGN KEY (DOCTORID) REFERENCES CNS_DOCTORS(ID);
ALTER TABLE CNS_FACTURE DISABLE CONSTRAINT CNS_FACTURE_CNS_DOCTORS_FK;